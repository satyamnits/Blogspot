        ...
        <div className="flex-none">
          <ul className="menu menu-horizontal px-3">
            {navItems.map((item) => 
              item.active ? (
                <li key={item.name}>
                  <a onClick={() => navigate(item.slug)} className='text-lg'>{item.name}</a>
                </li>
              ) : null
            )}
          </ul>
        </div>
        <label className="swap swap-rotate btn btn-ghost px-2">
          <input type="checkbox" />
          ...
          <div className="px-4 dropdown dropdown-end">
            <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
              <div className="w-10 rounded-full">
                <img alt="dp" src="https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" />
              </div>
            </div>
